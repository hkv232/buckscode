...
const Skill = ({name, x, y}) => {
  return (
    <motion.div className='py-3 px-3 shadow-dark flex items-center justify-center rounded-full font-semibold bg-dark text-light absolute dark:text-dark dark:bg-light'
...
const Skills = () => {
  return (
    ...
    <div className='w-[70vw] relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark h-[80vh] mx-auto'>
